...
function renderSettings(tab=SETTINGS_ACTIVE_TAB) {
  ...
  root.innerHTML = `
    <style>
      ...
      .settings-check-input{appearance:none;-webkit-appearance:none;width:18px;height:18px;border:1.5px solid var(--border-md);border-radius:5px;background:var(--surface);display:inline-grid;place-items:center;cursor:pointer;vertical-align:middle;transition:background-color .16s ease,border-color .16s ease,box-shadow .16s ease,transform .16s cubic-bezier(.22,1,.36,1);position:relative;flex:0 0 auto}.settings-check-input::after{content:"";width:8px;height:5px;border-left:2px solid #fff;border-bottom:2px solid #fff;transform:rotate(-45deg) scale(.35);opacity:0;transition:opacity .14s ease,transform .18s cubic-bezier(.22,1,.36,1)}.settings-check-input:hover{border-color:var(--blue);box-shadow:0 0 0 4px var(--focus-ring)}.settings-check-input:active{transform:scale(.88)}.settings-check-input:checked,.settings-matrix-toggle[aria-pressed="true"] .settings-check-input{background:var(--blue);border-color:var(--blue);animation:settings-check-pop .22s cubic-bezier(.22,1,.36,1)}.settings-check-input:checked::after,.settings-matrix-toggle[aria-pressed="true"] .settings-check-input::after{opacity:1;transform:rotate(-45deg) scale(1)}
      .settings-matrix-toggle .settings-check-input::after{content:"✓";width:auto;height:auto;border:0;color:#fff;font-size:13px;font-weight:900;line-height:1;transform:scale(.7);opacity:0}.settings-matrix-toggle[aria-pressed="true"] .settings-check-input::after{opacity:1;transform:scale(1)}
